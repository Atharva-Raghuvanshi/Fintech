      ...
      >
        <div className="h-16 border-b border-white/5 flex items-center justify-center px-4 shrink-0">
          {isOpen ? (
            ...
            <button onClick={() => setIsOpen(true)} className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-amber-400 via-orange-500 to-red-600 shadow-lg shadow-orange-500/30 ring-1 ring-white/20 hover:opacity-90 transition-opacity">
              <div className="w-3.5 h-3.5 border-2 border-white rounded-sm rotate-45 flex items-center justify-center">
                <div className="w-1 h-1 bg-white rounded-full"></div>
              </div>
            </button>
